...
- **[Приложение А: Руководство по созданию правил для Cline](appendix-rules.md)** — пошаговое руководство: когда создавать правила, как определять тип, карта категорий, дерево решений, правила написания и диагностика проблем.
- **[Приложение Б: Руководство по созданию скиллов для Cline](appendix-skills.md)** — полное руководство: прогрессивная загрузка, структура SKILL.md, 8 правил написания, decision trees, пример nextjs-vercel-deploy, чеклист перед публикацией.
